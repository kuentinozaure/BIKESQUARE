                ...
                <div className="tab-content" >
                    <div className="tab-pane fade show active p-3" role="tabpanel" aria-labelledby="one-tab">
                        <p className="card-text">
                            <img className="rounded float-center img-fluid img-thumbnail" width="100%" src={this.props.image}/>
                        </p>
                        <h5 className="card-title text-dark"></h5>
                        <p className="card-text  text-dark">{this.state.libelleSplit}</p>
                        <a  className="btn btn-primary " href={this.props.lien} target="_blank">En savoir plus</a>              
                    </div>
                </div>
            </div>
        </div>
